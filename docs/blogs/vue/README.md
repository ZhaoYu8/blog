...
众所周知，`修饰符`也是 Vue 的重要组成成分之一，利用好`修饰符`可以大大地提高开发的效率，接下来给大家介绍一下`面试官最喜欢问的13种Vue修饰符`

![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b0eac9340c824f59af8b19554eacced7~tplv-k3u1fbpfcp-watermark.image)
